    ...
    <section class="text-gray-600 body-font relative">
        <div class="container px-5 py-24 mx-auto">
          <div class="flex flex-col text-center w-full mb-12">
            ...
            <p class="lg:w-2/3 mx-auto leading-relaxed text-base">contact us for more information.</p>
          </div>
          @if (session()->has('success'))
            <div class="relative flex flex-col sm:flex-row sm:items-center bg-green-500 dark:bg-green-700 shadow rounded-md py-5 pl-6 pr-8 sm:pr-6 mb-3 mt-3">
        ...
        @endif
          ...
          <form action="/contact/traitement" method="POST">
            @csrf
